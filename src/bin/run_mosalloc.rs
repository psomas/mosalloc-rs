...
use mosalloc::utils::argparse::{default_node, parse_file_path, parse_hook_type, parse_size};
...
struct Cli {
    ...
    #[clap(long, value_parser = parse_hook_type, help = "hook type (preload or seccomp)")]
    hook_type: HookType,
